            ...
            <Layout
                footer={
                    <Button
                        label="Continue"
                        size="lg"
                        onPress={() => navigation.navigate('SumsubApplicant')}
                    />
                }
            >
                <View className="flex-1 justify-between">
                    <View>
                        ...
                        <Text className="text-base mb-2">Select your country of residence:</Text>
                        ...
                        <View className="mt-12">
                            <Text className="text-[15px] text-gray700">
                                ...
                                <Text className="text-orange"> Notification to Processing of Personal Data. </Text>
                            </Text>
                        </View>
                    </View>
                </View>
