    ...
    return (
        <View className='bg-white flex-1 items-start justify-start'>
            ...
            <Layout footer={<Button label="Continue" size="lg" />}>
                <View className='mb-3'>
                    <Text className="text-black font-inter-bold mb-3 text-h2 font-bold w-full">Activities</Text>
                </View>
                ...
                >
                    ...
                    />
                    <Text className='text-pb text-h5 font-inter-bold font-semibold'>Operations activity</Text>
                </Pressable>
            </Layout>
        </View>
    );
