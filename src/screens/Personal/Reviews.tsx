...
import { Clipboard, Copy, File } from "lucide-react-native";
      ...
      <Layout>
        ...
        <ScrollView contentContainerStyle={{ paddingBottom: 80 }}>
          ...
          <View className="flex-row justify-between items-center">
            ...
            <Pressable onPress={() => navigation.navigate("EditApplicant")}>
          ...
          <View className="flex-row justify-between items-center mt-6">
            ...
            <Pressable onPress={() => navigation.navigate("EditDocuments")}>
              <Text className="text-pb text-xl font-inter underline">Edit</Text>
            </Pressable>
          </View>
        ...
        <View className="px-4 pb-4">
          <ContButton onPress={() => navigation.navigate("VerifyIdentify")} />
        </View>
      </Layout>
    </View>
  );
