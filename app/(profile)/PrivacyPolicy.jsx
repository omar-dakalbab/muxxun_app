...
const PrivacyPolicy = () => {
    ...
    return (
        <View className='flex-1 bg-white'>
            <ScrollView>
                <HeaderNavigation />
                <Text className='text-3xl mt-5 mx-5 font-bold'>Privacy Policy</Text>
                ...
                <Text className='text-2xl mt-4 mx-5 font-bold'>Sed turpis tincidunt id aliquet risus feugiat.</Text>
