...
import { Contact, MessageSquareWarningIcon, PhoneCall, TriangleAlert, TriangleAlertIcon } from 'lucide-react-native';
        ...
        <View className="bg-white w-full h-[30%] p-5 rounded-t-lg shadow-lg">
          ...
          <View className="items-center justify-center">
            <View className="flex-column items-center justify-center mb-4 mt-3 bg-logoutTextColor w-16 h-16 p-4 rounded-full">
              <TriangleAlertIcon size={24} color="#FF0000" />
            </View>
            <Text>
          ...
          <View className="flex-row justify-between mt-8">
            <TouchableOpacity className="flex-1 bg-buttonLightRed text-white py-3 rounded-lg items-center mr-2">
              <Text className="text-white font-medium text-sm">Delete Account</Text>
            </TouchableOpacity>
